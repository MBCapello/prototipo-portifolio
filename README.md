...
O objetivo deste é praticar o desenvolvimento de paginas em html/css.
...
## Conhecimentos aplicado neste projeto:
- Elementos semânticos de bloco
- Links no HTML
- Box-model
- Reset de margins e paddings
- Retirando a underline dos links
- Modificando o tamanho das fontes
- Modificando o peso das fontes
- Modificar fontes
...
- Algoritmo do flexbox
- Margin auto e flexbox
- Debug no CSS
- Elementos de formulário
- Estilizando inputs e botões + propriedade all
